...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=CL-FC5LMN3;Database=FINAL;Integrated Security=true;trust server certificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Ordertable>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_Ordertable_UserID");
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasIndex(e => e.OrderId, "UQ__Payment__C3905BAE17E201A7")
                .IsUnique()
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.InventoryId, "UQ__Product__F5FDE6D28EC217AE")
                .IsUnique()
        ...
        modelBuilder.Entity<Shipment>(entity =>
        {
            ...
            entity.HasIndex(e => e.OrderId, "UQ__Shipment__C3905BAECDC586E4")
                .IsUnique()
                .HasFilter("([OrderID] IS NOT NULL)");
        ...
        modelBuilder.Entity<Usertable>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__Usertabl__A9D10534CBF6F0C8")
                .IsUnique()
        ...
        modelBuilder.Entity<Wishlist>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "UQ__Wishlist__1788CCADFA2835E7")
                .IsUnique()
        ...
        modelBuilder.Entity<WishlistItem>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductId, "IX_WishlistItem_ProductID");
